      ...
      <div className="help__card" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="help__columns">
          <section>
            ...
            <h2>Pieces</h2>
            <p>Every piece eats one food as your phase begins — unfed pieces are too hungry to act, so match your army to your farmland. A house farms at most three neighboring grass tiles, and each farm feeds only one house: spread out for more fields. Peasants need housing: each house holds one, a homestead two, a manor three — the header shows peasants housed / room. Peasants work, fight and can carry a sword (+1 attack), shield (+1 defense) or bow (+1 range), plus iron armour — helmet, cuirass, greaves — worth +1 defense each; buy any of it with the + in the peasant's panel. Priests heal. Your castle stands from the first turn; upgrade it for reach, defense and research. Towers grow the same way: Watchpost (5 stone, sees 2) → Watchtower (8 stone, sees 3) → Beacon (12 stone, sees 4) — a bow inside shoots as far as the tower sees. Archangels are summoned with faith and ten praying priests.</p>
          </section>
          <section>
            <h2>Controls</h2>
